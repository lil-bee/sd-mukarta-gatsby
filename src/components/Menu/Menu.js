...
export const Menu = () => {
  ...
  return (
    <div className="from-british-racing-green sticky top-0 z-20 flex h-16 items-center justify-between bg-emerald-900 bg-gradient-to-tr to-emerald-900 px-10 font-bold text-white">
      <Link to="/">
        <StaticImage
          src="../../../static/icon.png"
          height={30}
